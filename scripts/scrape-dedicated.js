#!/usr/bin/env node
/**
 * Scrapes https://crimson-ceremony.net/demopals/dedicated/index.php
 * and writes src/data/dedicated.json.
 *
 * Run: node scripts/scrape-dedicated.js
 */
...
const PAGE_URL = `${BASE_URL}/demopals/dedicated/index.php`;
const OUT_PATH = path.join(__dirname, '..', 'src', 'data', 'dedicated.json');
