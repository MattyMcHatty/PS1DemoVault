#!/usr/bin/env node
/**
 * Scrapes https://crimson-ceremony.net/demopals/essential/index.php
 * and builds a SQLite database of all Essential PlayStation disc variants.
 *
 * Run: node scripts/scrape-essential.js
 */
...
const PAGE_URL   = `${BASE_URL}/demopals/essential/index.php`;
